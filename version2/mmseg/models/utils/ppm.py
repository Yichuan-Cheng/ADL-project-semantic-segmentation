...
class DRPPM(BaseModule):
    ...
    def __init__(self,
                 ...
                 out_channels: int,
                 num_scales: int,
                 kernel_sizes: List[int] = [17, 9, 5],
                 strides: List[int] = [8, 4, 2],
                 paddings: List[int] = [8, 4, 2],
        ...
        self.dappm=DAPPM(in_channels,branch_channels,out_channels,num_scales,kernel_sizes,strides,paddings,norm_cfg,act_cfg,conv_cfg,upsample_mode)

        self.scales = ModuleList([Sequential(*[
    ...
    def forward(self, inputs: Tensor):
        ...
        return self.compression(torch.cat(feats,dim=1)) + self.dappm(inputs) 
